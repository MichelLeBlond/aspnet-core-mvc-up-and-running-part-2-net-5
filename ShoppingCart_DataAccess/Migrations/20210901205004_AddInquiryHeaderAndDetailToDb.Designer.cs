...
namespace ShoppingCart_DataAccess.Migrations
{
    ...
    [Migration("20210901205004_AddInquiryHeaderAndDetailToDb")]
            ...
            modelBuilder.Entity("ShoppingCart_Models.InquiryDetail", b =>
                {
                    ...
                    b.Property<int>("InqueryHeaderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShoppingCart_Models.InquiryDetail", b =>
                {
                    b.HasOne("ShoppingCart_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InqueryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShoppingCart_Models.InquiryHeader", "Product")
                        .WithMany()
